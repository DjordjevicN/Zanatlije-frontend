...
function SideBarRight(props) {
    ...
    let userAvatar = gravatar.url('nikola.dj.87@gmail.com', { s: '200', r: 'pg', d: '404' });
    ...
    return (
        <div className='sideBarRight__wrapper'>
            ...
            <div className='sideBarRight__item'><Link to='/userProfile' className='link linkWithIcon'><MdPerson className='sideBarRight__item--icon' /> <p>{props.authUser.userName}</p></Link> </div>
            <div className='sideBarRight__item' onClick={() => {
            ...
            <div className='sideBarRight__item' ><Link to='/offers' className='link linkWithIcon'><MdInbox className='sideBarRight__item--icon' /><p>Poslate Ponude</p></Link></div>
        </div>
    );
}
