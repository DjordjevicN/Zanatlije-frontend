                    ...
                    <div className="editUserFormModal__content">
                        <div className="form">
                            <div className="inputElement">
                                <input type="text" className="input" placeholder='Kategorija' onChange={(e) => {
                                    setServiceCategory(e.target.value)
                                }} />
                            </div>
                            <div className="inputElement">
                                <input type="number" className="input" placeholder='Cena' onChange={(e) => {
                                    setServicePrice(e.target.value)
                                }} />
                            </div>
                            <div className="inputElement">
                                <CKEditor className="ck-editor__editable ckInput" editor={ClassicEditor} onChange={(event, editor) => {
